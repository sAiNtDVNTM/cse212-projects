...
public static class StandardDeviation {
    ...
    private static double StandardDeviation1(int[] numbers) { //sould be O(n)
        var total = 0.0;
        var count = 0;
    ...
    private static double StandardDeviation2(int[] numbers) { //should be O(n²)
        var sumSquaredDifferences = 0.0;
        var countNumbers = 0;
        foreach (var number in numbers) {
            var total = 0;
    ...
    private static double StandardDeviation3(int[] numbers) { //should be O(n)
